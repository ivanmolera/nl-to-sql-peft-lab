...
FINE_TUNED_MODEL_SPECS = [
    ...
    {
        "id": "gpt2-qlora",
        "name": "openai-community/gpt2 + QLoRA",
        "architecture": "causal",
        "role": "GPT-2 fine-tuned on WikiSQL with QLoRA",
        "base_model_name": "openai-community/gpt2",
        "adapter_path": ROOT_DIR / "model_artifacts" / "qlora" / "gpt2-wikisql-qlora" / "adapter",
        "peft_method": "qlora",
        "adapter_type": "peft",
    },
    {
    ...
    {
        "id": "gpt2-bitfit",
        "name": "openai-community/gpt2 + BitFit",
        "architecture": "causal",
        "role": "GPT-2 fine-tuned on WikiSQL with BitFit",
        "base_model_name": "openai-community/gpt2",
        "adapter_path": ROOT_DIR / "model_artifacts" / "bitfit" / "gpt2-wikisql-bitfit" / "adapter",
        "peft_method": "bitfit",
        "adapter_type": "bitfit",
    },
    {
